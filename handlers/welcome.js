  ...
  client.on("guildMemberAdd", async mem => {
    ...
    async function welcome(member) {
      ...
      if (invite && inviter) {
        ...
        invitemessage = `Invited by ${inviter.tag ? `**${inviter.tag}**` : `<@${inviter.id}>`}\n<:Like:935540479313989662> **${realinvites} Invite${realinvites == 1 ? "" : "s"}**\n[<:Joines:950793039348109312> ${invites} Joins | <:Leaves:950793611593793556> ${leaves} Leaves | <:M_x:950441844544794654> ${fake} Fakes]`;
      } 
      else if(invite){

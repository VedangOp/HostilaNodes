...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let menuoptions = [
        {
          ...
          emoji: "950793039348109312" //optional
        },
        {
          value: "Remove Joins",
        ...
        },
        {
          ...
          emoji: "950441844544794654" //optional
        },
        {
          value: "Remove Fakes",
        ...
        },
        {
          ...
          emoji: ":950793611593793556" //optional
        },
        {
          value: "Remove Leaves",
      ...
      .addField("**CURRENT INVITES:**", `<:Like:935540479313989662> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          ...
          message.reply({embeds : [new MessageEmbed()
            ...
            .addField("\u200b", `<:Like:935540479313989662> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)

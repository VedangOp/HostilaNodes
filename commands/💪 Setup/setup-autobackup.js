...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:M_x:950441844544794654> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:M_x:950441844544794654> **You need to be the Owner of this Server!**`)
      }
        ...
        let menuoptions = [
          {
            ...
            emoji: !client.settings.get(message.guild.id, "autobackup") ? "950441315823411243" : "950441844544794654"
          },
          {
            value: "Cancel",

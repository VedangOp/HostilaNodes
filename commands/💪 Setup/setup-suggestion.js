  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:Yes:950441315823411243> Accepted Idea! Expect this soon.`,
          denymsg: `<:M_x:950441844544794654> Thank you for the feedback, but we are not interested in this idea at this time.`,
          ...
          approveemoji: `950441315823411243`,
          denyemoji: `950441844544794654`,
        }
    });
      */

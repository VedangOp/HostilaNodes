...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try{
        ...
        //send the message of the searching <a:Music:950791431931457546> <a:Music:950791431931457546> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:Music:950791431931457546> Setup Complete for Radio Station:  " + song.title)
                .setColor("#7fafe3")
